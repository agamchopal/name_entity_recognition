...
train=[("Apple is a fruit.", {"entities": [(0, 5, "Fruit")]}),
   ("brinjal", {"entities": [(0, 7, "Vegetable")]}),
        ("Vitamin D", {"entities": [(0, 9, "Vitamin")]}),
        ("Vitamin E", {"entities": [(0, 9, "Vitamin")]}),
        ("Vitamin K", {"entities": [(0, 9, "Vitamin")]}),
        ("Vitamin B1", {"entities": [(0, 10, "Vitamin")]}),
         ("Vitamin B2", {"entities": [(0, 10, "Vitamin")]}),
         ("Vitamin B3", {"entities": [(0, 10, "Vitamin")]}),
         ("Vitamin B5", {"entities": [(0, 10, "Vitamin")]}),
          ("Vitamin B6", {"entities": [(0, 10, "Vitamin")]}),
          ("Vitamin B7", {"entities": [(0, 10, "Vitamin")]}),
          ("Vitamin B9", {"entities": [(0, 10, "Vitamin")]}),
           ("Vitamin B12", {"entities": [(0, 11, "Vitamin")]}),
...
def main():
    ...
    if st.button("Show Output"):
         st.text("Highlighted Output with Entities and Labels.")
